...
if is_transformers_available() and is_torch_available():
    ...
    from .pipeline_stable_diffusion_hetu import StableDiffusionPipeline
    from .pipeline_stable_diffusion_edit_hetu import StableDiffusionPipelineEdit
    from .pipeline_stable_diffusion_edit_hetu import HetuUnetConfig
