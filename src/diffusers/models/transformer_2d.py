...
class Transformer2DModel(ModelMixin, ConfigMixin):
    ...
    def build_hetu(
        ...
        if self.use_linear_projection:
            ...
            hidden_states = ht.linear_op(hidden_states, weights, bias, trans_B=True, name="Transform1", config=config)
        else:
            ...
            # Fuse GroupNorm + Sparse Conv together.
                ...
                gn_bias = ht.Variable(name + 'norm_bias', value=ht.array(self.norm.bias, ctx=ctx))
        ...
        if self.use_linear_projection:
            ...
            hidden_states = ht.linear_op(hidden_states, weights, bias, trans_B=True, name="Transform2", config=config)
            hidden_states = ht.array_reshape_op(hidden_states, (config.batch, config.height, config.width, self.inner_dim))
